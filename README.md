## Deprecated: this repo is now located part of [kubernetes/contrib](https://github.com/kubernetes/contrib/tree/master/keepalived-vip)
...
kube-keepalived-vip   kube-keepalived-vip   aledbf/kube-keepalived-vip:0.1   name in (kube-keepalived-vip)   type=worker
```
...
```
old-mbp:kube-bgp-vip aledbf$ kubectl get pods
...
```
old-mbp:github aledbf$ kubectl logs kube-keepalived-vip-a90bt
...
````
old-mbp:github aledbf$ kubectl exec kube-keepalived-vip-a90bt cat /etc/keepalived/keepalived.conf
